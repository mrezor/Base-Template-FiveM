ESX.StartPayCheck = function()
	...
	function payCheck()
		...
		for i = 1, #xPlayers, 1 do
			...
			if xPlayer.getGroup() == "Silver" then
				xPlayer.addInventoryItem("crystal", 3)
			elseif xPlayer.getGroup() == "Gold" then
				xPlayer.addInventoryItem("crystal", 3)
			elseif xPlayer.getGroup() == "Platinum" then
				xPlayer.addInventoryItem("crystal", 4)
			elseif xPlayer.getGroup() == "Diamond" then
				xPlayer.addInventoryItem("crystal", 5)
			elseif xPlayer.getGroup() == "Crystal" then
				xPlayer.addInventoryItem("crystal", 6)
			...
			elseif xPlayer.getGroup() == "superadmin" then
				...
				xPlayer.addInventoryItem("crystal", 2)
			end
